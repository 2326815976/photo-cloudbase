...
CREATE TABLE IF NOT EXISTS album_photos (
  ...
  sort_order INT UNSIGNED NOT NULL DEFAULT 2147483647,
  shot_date DATE NULL,
  shot_location VARCHAR(255) NULL,
  width INT NULL,
  height INT NULL,
...
CREATE TABLE IF NOT EXISTS app_page_registry (
  ...
  is_nav_candidate_web TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS app_page_publish_rules (
  ...
  header_title VARCHAR(64) NULL,
  header_subtitle VARCHAR(64) NULL,
...
FROM (
  ...
  UNION ALL SELECT 'profile-beta', '内测功能', '我的页内测功能入口', '/profile/beta', 'pages/profile/beta/index', '/profile/beta?presentation=preview&page_key=profile-beta', '/pages/profile/beta/index?presentation=preview&page_key=profile-beta', NULL, NULL, '内测功能', '内测功能', 0, 0, 0, 1
