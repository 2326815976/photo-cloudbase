...
-- 字段注释
COMMENT ON COLUMN public.profiles.nickname IS '用户昵称，用于评论显示';
...
CREATE TABLE IF NOT EXISTS public.albums (
  ...
  cover_url text,
  welcome_letter text,
  recipient_name text DEFAULT '拾光者',
...
-- 字段注释
COMMENT ON COLUMN public.albums.expires_at IS '相册过期时间';
COMMENT ON COLUMN public.albums.recipient_name IS '收件人名称，默认为"拾光者"';
COMMENT ON COLUMN public.albums.donation_qr_code_url IS '赞赏码图片URL';
COMMENT ON COLUMN public.albums.created_by IS '相册创建者，用于级联删除';

-- ================================================================================================
-- 5. 照片与互动 (Photos, Comments, Likes)
-- ================================================================================================
